package com.rrhostel.Chat.Fragment.FriendFragment.GroupFragment;
...
import com.rrhostel.Chat.AddGroupActivity;
import com.rrhostel.Chat.DataBase.FriendDB;
import com.rrhostel.Chat.DataBase.GroupDB;
import com.rrhostel.Chat.Model.Group;
import com.rrhostel.Chat.Model.ListFriend;
import com.rrhostel.Chat.SingleChat.ChatActivity;
...
public class GroupFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getListGroup() {
        FirebaseDatabase.getInstance().getReference().child("user/" + Constant.UID + "/group").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case CONTEXT_MENU_DELETE:
                ...
                if (((String) listGroup.get(posGroup).groupInfo.get("admin")).equals(Constant.UID)) {
            ...
            case CONTEXT_MENU_EDIT:
                ...
                if (((String) listGroup.get(posGroup1).groupInfo.get("admin")).equals(Constant.UID)) {
            ...
            case CONTEXT_MENU_LEAVE:
                ...
                if (((String) listGroup.get(position).groupInfo.get("admin")).equals(Constant.UID)) {
    ...
    public void leaveGroup(final Group group) {
        FirebaseDatabase.getInstance().getReference().child("group/" + group.id + "/member")
                .orderByValue().equalTo(Constant.UID)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.getValue() == null) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("user").child(Constant.UID)
            ...
            public void onClick(View view) {
                ...
                for (String id : listGroup.get(position).member) {
                    ...
                    if (!avata.equals(Constant.STR_DEFAULT_BASE64)) {
                        ...
                        ChatActivity.bitmapAvataFriend.put(id, BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_user_profile));
                    } else {
